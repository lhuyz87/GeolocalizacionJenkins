...
Feature: Central de procuración
  ...
  Scenario Outline: Asignar procurador
    ...
    Then la atención  seleccionada debe cambiar de estado "<estado>" a En camino
      ...
      |1|clegall@gmail.com|Test2019#|ABA259|PROCURADOR AUTO1|En camino|
      |2|clegall@gmail.com|Test2019#|ABA260|PROCURADOR AUTO2|En camino|
      |3|clegall@gmail.com|Test2019#|ABA261|PROCURADOR AUTO3|En camino|
      |4|clegall@gmail.com|Test2019#|ABA262|PROCURADOR AUTO4|En camino|
